...
<link rel="icon" href="../../../../../../_static/favicon.png">
  ...
  <title>Introduction &mdash; Jina 2.0.0rc5 documentation</title>
...
<a class="reference external image-reference" href="https://pypi.python.org/pypi/pbr/"><img alt="Latest Version" src="https://img.shields.io/pypi/v/pbr.svg" /></a>
<a class="reference external image-reference" href="https://pypi.python.org/pypi/pbr/"><img alt="Downloads" src="https://img.shields.io/pypi/dm/pbr.svg" /></a>
<p>PBR is a library that injects some useful and sensible default behaviors
into your setuptools run. It started off life as the chunks of code that
were copied between all of the <a class="reference external" href="https://www.openstack.org/">OpenStack</a> projects. Around the time that
OpenStack hit 18 different projects each with at least 3 active branches,
it seemed like a good time to make that code into a proper reusable library.</p>
...
really need PBR.</p>
<p>PBR builds on top of the work that <a class="reference external" href="https://pypi.python.org/pypi/d2to1">d2to1</a> started to provide for declarative
configuration. <a class="reference external" href="https://pypi.python.org/pypi/d2to1">d2to1</a> is itself an implementation of the ideas behind
<a class="reference external" href="https://pypi.python.org/pypi/Distutils2">distutils2</a>. Although <a class="reference external" href="https://pypi.python.org/pypi/Distutils2">distutils2</a> is now abandoned in favor of work towards
<a class="reference external" href="http://legacy.python.org/dev/peps/pep-0426/">PEP 426</a> and Metadata 2.0, declarative config is still a great idea and
...
<ul class="simple">
<li><p>License: Apache License, Version 2.0</p></li>
<li><p>Documentation: <a class="reference external" href="https://docs.openstack.org/pbr/latest/">https://docs.openstack.org/pbr/latest/</a></p></li>
<li><p>Source: <a class="reference external" href="https://opendev.org/openstack/pbr">https://opendev.org/openstack/pbr</a></p></li>
<li><p>Bugs: <a class="reference external" href="https://bugs.launchpad.net/pbr">https://bugs.launchpad.net/pbr</a></p></li>
<li><p>Release Notes: <a class="reference external" href="https://docs.openstack.org/pbr/latest/user/releasenotes.html">https://docs.openstack.org/pbr/latest/user/releasenotes.html</a></p></li>
<li><p>ChangeLog: <a class="reference external" href="https://docs.openstack.org/pbr/latest/user/history.html">https://docs.openstack.org/pbr/latest/user/history.html</a></p></li>
</ul>
</div>

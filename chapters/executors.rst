==========================================
A Guide to Jina Executors
==========================================

.. meta::
   :description: A guide on Jina Executors
...
Like we said, we have 7 types of Execturos in Jina, so let's see an example with one of them and how we could see it in action.
...
Another way to use them is directly in your Phyton file. Let's use a :term:`Crafter` this time, for example the `Image Normalizer <https://github.com/jina-ai/jina-hub/tree/master/crafters/image/ImageNormalizer>`_
